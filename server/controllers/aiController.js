...
//POST: /api/ai/enhance-job-descriptions
    ...
    try{
        ...
        if(!userContent){
         ...
         const response=await ai.chat.completions.create({
            ...
            messages: [
                 { role: "system",
                     content: "You are an expert in resume writing.Your task is to enhance the job descriptions of a resume. The job descriptions should be only 1-2 sentences also highlighting key achievements and responsibilities. Use action verbs and quantifiable results where possible. Make it ATS-friendly and only return text no options or anything else."},
                {
                    role: "user",
                    content:userContent,
                },
